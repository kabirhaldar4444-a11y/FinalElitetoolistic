                ...
                <div className="pt-4 text-left space-y-4">
                  ...
                  {scriptLang === 'marathi' && (
                    <div className="bg-white p-4 rounded-2xl border border-amber-100 text-slate-700 font-medium space-y-2.5 text-[11px] leading-relaxed shadow-sm animate-fade-in">
                      ...
                      <p>
                        "माझे नाव <strong>{fullName || '[कँडिडेटचे नाव]'}</strong> आहे आणि माझा नोंदणीकृत ईमेल आयडी <strong>{email || '[ईमेल आयडी]'}</strong> आहे. मी माझे प्रोफाइल सत्यापित करण्यासाठी, माझी ओळख निश्चित करण्यासाठी आणि एलिट टूलिस्टिकच्या (elitetoolistic.com) व्यावसायिक प्रशिक्षण कार्यक्रमातील माझे प्रवेश निश्चित करण्यासाठी हा व्हिडिओ विधान स्वेच्छेने रेकॉर्ड केला आहे."
                      </p>
                      <p>
